package br.com.futurodev.project_utilities.controller;

import br.com.futurodev.project_utilities.client.ViaCepClient;
import br.com.futurodev.project_utilities.model.transport.ViaCepDTO;
...
@RequestMapping("/cep")
@Tag(
        name = "ViaCEP Controller",
        description = "Controller para operações com a API do ViaCEP"
)
